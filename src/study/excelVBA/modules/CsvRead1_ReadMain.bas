Attribute VB_Name = "CsvRead1_ReadMain"
Option Explicit
Private Enum sales
'Public Enum sales
    startCol = 0
...
Public Sub ReadMain()
    ...
    Set dicFormalData = New Dictionary
    Dim dicExistData As Dictionary
    Set dicExistData = New Dictionary
    Dim dicAddData As Dictionary
    Set dicAddData = New Dictionary
    ...
    '// ³‹K‚Ìƒf[ƒ^‚ğ’è‹`
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    Call GetFormalData(dicFormalData)
    ...
    Call RunGetFolderPath(cls03, cls04, openFolderPath, filePaths, fatalCheck)
    
    If fatalCheck = True Then GoTo fatalError
    
     '// ƒtƒ@ƒCƒ‹‚ğ“Ç‚İ‚Ş
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    Call RunReadCsvFile(cls02, filePaths, readCsv, readYear, addData, dicFormalData, dicExistData, dicAddData)
...
'  ƒtƒHƒ‹ƒ_î•ñ‚ğæ“¾‚·‚é
'// ------------------------------------------------------------------
Public Sub RunGetFolderPath(ByRef cls03 As Cls3_fso, ByRef cls04 As Cls4_Log, _
                                          ByRef openFolderPath As String, ByRef filePaths As Variant, ByRef fatalCheck As Boolean)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    If IsFolderExist(cls04, openFolderPath) = False Then
        '// F001
...
ErrorHandler:
    ...
    Err.Raise Err.Number, , Err.Description
End Sub
Public Function IsFolderExist(ByRef cls04 As Cls4_Log, ByVal openFolderPath As String) As Boolean
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
...
'  csvƒtƒ@ƒCƒ‹‚ğ“Ç‚İ‚Ş
'// ------------------------------------------------------------------
Public Sub RunReadCsvFile(ByRef cls02 As Cls2_csv, _
                                       ByRef filePaths As Variant, ByRef readCsv As Variant, ByRef readYear As Variant, ByRef addData As Variant, _
                                       ByRef dicFormalData As Dictionary, ByRef dicExistData As Dictionary, ByRef dicAddData As Dictionary)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    For Each filePath In filePaths
        Call ReadOneCsv(cls02, filePath, readCsv, readYear, addData, dicFormalData, dicExistData, dicAddData)
    Next
...
ErrorHandler:
    ...
    Err.Raise Err.Number, , Err.Description
End Sub
Public Sub ReadOneCsv(ByRef cls02 As Cls2_csv, ByRef filePath As Variant, ByRef readCsv As Variant, ByRef readYear As Variant, ByRef addData As Variant, _
                                  ByRef dicFormalData As Dictionary, ByRef dicExistData As Dictionary, ByRef dicAddData As Dictionary)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    With cls02
        ...
        'PPPPPPPPPPPPPPPPPPPPPPPPP
        If .IsCharCode(filePath, charCode) = False Then
    ...
    '// ğŒ‚ğ–‚½‚µ‚½ƒf[ƒ^‚ğæ‚è‚Ş
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    Call RunImportCsv(readCsv, readYear, addData, dicExistData, dicFormalData, dicAddData)
...
'  ƒtƒ@ƒCƒ‹‚ğ‚P‚Â‚¸‚Âæ“¾‚·‚é
'// ------------------------------------------------------------------
Public Sub RunImportCsv(ByRef readCsv As Variant, ByRef readYear As Variant, ByRef addData As Variant, _
                                    ByRef dicExistData As Dictionary, ByRef dicFormalData As Dictionary, ByRef dicAddData As Dictionary)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    '// æˆø”N‚ğæ“¾
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    Call GetBusinessYears(readCsv, readYear)
    ...
    For Each targetYear In readYear
        ...
        '// ğŒ‚ğ–‚½‚·ƒf[ƒ^‚ğæ“¾‚·‚é
        'PPPPPPPPPPPPPPPPPPPPPPPPP
        Dim flagAdd As Boolean: flagAdd = True
        
        Call RunConditionsData(dicExistData, dicAddData, dicFormalData, readCsv, targetYear, addData, flagAdd)
...
'// ------------------------------------------------------------------
Public Sub GetBusinessYears(ByRef readCsv As Variant, ByRef readYear As Variant)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
...
'  ğŒ‚ğ–‚½‚·sƒf[ƒ^‚ğæ“¾‚·‚é
'// ------------------------------------------------------------------
Public Function RunConditionsData(ByRef dicExistData As Dictionary, ByRef dicAddData As Dictionary, ByRef dicFormalData As Dictionary, _
                                                  ByRef readCsv As Variant, ByVal targetYear As String, ByRef addData As Variant, ByRef flagAdd As Boolean) As Boolean
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    For rowCount = LBound(readCsv, 2) To UBound(readCsv, 2) Step 1
        For colCount = LBound(readCsv, 1) To UBound(readCsv, 1) Step 1
            ...
            '// ”z—ñ‚ğÄ’è‹`
            'PPPPPPPPPPPPPPPPPPPPPPPPP
            ReDim Preserve items(sales.endcol)
            items(colCount) = readCsv(colCount, rowCount)
            ...
            '// Šù‘¶ƒf[ƒ^‚Æ‚Ìd•¡‚ğ”»’f‚·‚é
            'PPPPPPPPPPPPPPPPPPPPPPPPP
            If CanAddData(dicExistData, dicAddData, readCsv, items, key) = False Then
                '// E005
                
                flagAdd = False
                Exit For
            Else
                Call GetAddData(dicAddData, key) '// ’Ç‰Áƒf[ƒ^‚ğdictionary‚É’Ç‰Á
            End If
        Next colCount
    Next rowCount
...
End Function
'// ------------------------------------------------------------------
'  Šù‘¶ƒf[ƒ^‚Æd•¡‚µ‚Ä‚¢‚È‚¢‚©”»’è‚·‚é
'// ------------------------------------------------------------------
Public Function CanAddData(ByRef dicExistData As Dictionary, ByRef dicAddData As Dictionary, ByRef readCsv As Variant, ByRef items As Variant, ByRef key As String) As Boolean
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    ...
    If dicExistData.Exists(key) = False Then
        GetAddData = True '// ƒtƒ‰ƒO‚ğtrue‚É•ÏX
    End If
...
'  ’Ç‰Áƒf[ƒ^‚ğæ“¾‚·‚é
'// ------------------------------------------------------------------
Public Sub GetAddData(ByRef dicAddData As Dictionary, ByRef key As String)
    '// —\Šú‚¹‚ÊƒGƒ‰[ŒŸ’m
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    On Error GoTo ErrorHandler
    
    '// key‚ğdictionary‚É’Ç‰Á‚·‚é
    'PPPPPPPPPPPPPPPPPPPPPPPPP
    dicAddData.Add key, True
